...
abstract class AppLocalizations {
  ...
  /// No description provided for @viewPastOrders.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @aboutClothy.
  ///
  /// In en, this message translates to:
  /// **'Learn more about Clothy'**
  String get aboutClothy;
  ...
  /// No description provided for @getOrderNotifications.
  ///
  /// In en, this message translates to:
  /// **'Get notified about order status'**
  String get getOrderNotifications;
  ...
  /// No description provided for @receivePromotions.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @receiveEmails.
  ///
  /// In en, this message translates to:
  /// **'Receive emails about your account'**
  String get receiveEmails;
}
